<div class="pagination">
	<ul>
		...
		<?php else: ?>
			<li><?php echo $this->linkTo('First', $this->admin_posts_url([
				'page'	=> 1,
				'sort'	=> $this->param('sort'),
				'sort_type' => $this->param('sort_type')
			])); ?></li>
			<li><?php echo $this->linkTo('Prev', $this->admin_posts_url([
		...
		<?php for ($i = $this->pagination['lower']; $i <= $this->pagination['upper']; $i++): ?>
			<li<?php echo ($i == $this->pagination['currentPage']) ? ' class="active"' : ''; ?>>
				<?php echo $this->linkTo($i, $this->admin_posts_url([
						'page' => $i,
						'sort'	=> $this->param('sort'),
						'sort_type' => $this->param('sort_type')
					])); ?>
		...
		<?php else: ?>
			<li><?php echo $this->linkTo('Next', $this->admin_posts_url([
				'page'	=> $this->pagination['nextPage'],
				'sort'	=> $this->param('sort'),
				'sort_type' => $this->param('sort_type')
			])); ?></li>
			<li><?php echo $this->linkTo('Last', $this->admin_posts_url([
