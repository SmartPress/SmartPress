...
?>
<?php echo $this->formFor(['admin', $this->post], [
		'class' => 'smart_press-form', 
		'action' => (empty($this->post->id)) ? 
			'/admin/pages' : '/admin/pages/' . $this->post->id
		], 
		function($f) { ?>
	...
	<?php if (!empty($this->post->id)): ?>
		<?php echo $this->hiddenFieldTag('_method', Draw::PUT); ?>
	<?php endif; ?>
